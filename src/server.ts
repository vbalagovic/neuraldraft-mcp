...
import { registerDeletePageTool } from "./tools/delete-page.js";
import { registerDeleteComponentTool } from "./tools/delete-component.js";
...
export function createMcpServer({ config, client }: BuildServerOptions): McpServer {
  ...
  registerDeleteContentTool(server, ctx);
  registerDeletePageTool(server, ctx);
  registerDeleteComponentTool(server, ctx);
  registerListGalleriesTool(server, ctx);
  registerGetGalleryTool(server, ctx);
  registerCreateGalleryTool(server, ctx);
  registerUpdateGalleryTool(server, ctx);
  registerDeleteGalleryTool(server, ctx);
